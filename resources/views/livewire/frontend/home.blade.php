                                                                    ...
                                                                    <div class="event-registration variation_0">
                                                                        <div class="etn-row align-items-center etn-form-wrap">
                                                                            ...
                                                                            <div class="col-md-5 etn-single-ticket-item">
                                                                                ...
                                                                                <!-- ./item -->
{{--                                                                                <input name="ticket_price[]" type="hidden" value="529" />--}}
{{--                                                                                <input name="ticket_name[]" type="hidden" value="DEFAULT" />--}}
{{--                                                                                <input name="ticket_slug[]" type="hidden" value="482-default-5ac17" />--}}
                                                                            </div>
                                                                            <!-- ./col -->
                                                                            <div class="col-md-3">
                                                                                <!-- price_btn -->
                                                                                <a href="{{'/ticket-info'}}/{{ $ticket->id }}" class="exhibz-btn whitespace--normal">
                                                                                        <span class="exhibz-button-text">
                                                                                            Grab
                                                                                            <span>Ticket</span>
                                                                                        </span>
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="56" height="50" viewBox="0 0 56 50" fill="none">
                                                                                        <path d="M29.713 48.6221L22.9954 42.5031L33.2108 32.0607L34.8731 30.3614L32.4959 30.3614L1 30.3614L1 19.6386L32.4959 19.6386L34.8731 19.6386L33.2108 17.9393L22.9954 7.49689L29.7119 1.37891L53.602 25.0394L29.713 48.6221Z" stroke="#F52722" stroke-width="2"></path>
                                                                                    </svg>
                                                                                </a>
